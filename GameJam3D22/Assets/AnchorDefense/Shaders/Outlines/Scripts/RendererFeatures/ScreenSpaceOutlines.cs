...
public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            if (normals == null || normals.rt == null)
                return;
    ...
    public override void Create()
    {
        ...
        {
            Debug.LogError("ScreenSpaceOutlines: �Ҳ��� Shader \"Hidden/Outlines\"������ Outlines Shader ��һ�е����֡�");
        ...
        {
            Debug.LogError("ScreenSpaceOutlines: �Ҳ��� Shader \"Hidden/ViewSpaceNormals\"������ ViewSpaceNormals Shader ��һ�е����֡�");
            screenSpaceOutlinePass = null;
            return;
        }
